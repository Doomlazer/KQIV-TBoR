							...
							(((Inventory at: iLute) ownedBy: 203)
								...
								(switch minstrelResponse
									(1
										...
										(thisSong number: 17 loop: -1 play: minstrelActions)
									)
									(2
										(Print 516 10)
										;(thisSong number: 16 play: minstrelActions)
										(thisSong number: 19 loop: -1 play: minstrelActions)
									)
									(3
										(Print 516 11)
...
(instance minstrelActions of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(11
				(Print 516 18 #icon 414 0 0 #dispose)
				(= gotItem TRUE)
			...
			(21
				(Print 516 20 #icon 414 0 0 #dispose)
				(= gotItem TRUE)
