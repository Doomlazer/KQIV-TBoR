					...
					(cond 
						...
						((Said 'look>')
							(cond 
								...
								((or (Said '/hemp,ladder') (Said '/hemp[<heap]')) (if (== ropeLadderLowered FALSE) (Print 69 4) else (Print 69 5)))
						...
						((Said 'get,move,lower/hemp,ladder,heap')
							(cond 
						...
						((Said 'open/casket,lid')
							(cond 
								((not climbedDown) (PrintNotCloseEnough))
								((coffinLid cel?) (Print 69 23 #at -1 10))
								(else (Print 69 2))
							)
						)
						((Said 'get,move/casket') (if climbedDown (Print 69 24) else (PrintNotCloseEnough)))
						...
						((Said '/mummy>')
							(cond 
								...
								((Said 'help,save') (Print 69 30))
							)
						)
						((Said 'deliver/anyword/mummy') (if mummyAwake (Print 69 31) else (Print 69 11)))
					)
				)
			)
		)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(Print {Nobody going to believe you found this!} #icon 425 0 0)
				(pandoraBox dispose:)
