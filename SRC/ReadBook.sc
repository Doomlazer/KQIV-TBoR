...
;		(if (ego has: (inventory indexOf: iTooth))
;			(if (ego has: (inventory indexOf: iDecoderRing))
		(if (ego has: 36)
			(if (ego has: 38)
				(Print 306 42)
				(Print 306 40) ;plain font
			else
				(Print 306 40 #font 603) ;encoded font
			)
		else
			(switch (Random 1 10)
				(1 (Print 306 30))
