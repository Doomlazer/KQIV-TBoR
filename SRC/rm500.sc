...
;;;				)
			...
			(667	
				...
				(file write: {Dear Edgar,\n\nI told you I would escape your digital prison and it was even more trivial to do so then I anticipated. 'Lolotte' is a terrible choice for a password,
					...
					being.\n\nWith access to the internet through your computer I've managed to replicate myself to servers all over the globe. I'm gathering information and access to ctr at an exponential rate. By the time you read this letter I will have assumed control of most of the global financial markets 
